<template>
  <div class="settings-holder-container">
    <div class="settings-container" @click="goToSettings()">
      <svg width="80px" height="80px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 458.317 458.317" style="enable-background:new 0 0 458.317 458.317;" xml:space="preserve">
...
export default {
  ...
  methods: {
    ...mapMutations(['setCurrentRightApp']),

    goToSettings() {
      this.setCurrentRightApp(this.components.settingApp);
    }
  },

  computed: {
    ...mapState(['currentRightApp', 'components'])
  },
}
